...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'next', // 当主题名称就前主题，在themes文件夹下可找到所有支持的主题；是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '探索AI的数字游民，陪您高效开心工作💼', // 作者简介
