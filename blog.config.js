...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'hexo', // 当主题名称就前主题，在themes文件夹下可找到所有支持的主题；是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  GREETING_WORDS:
    ...
    'Hi，我是凯叔，一名全身心投入于AI技术、互联网营销和网络创业的数字游民。我将带你探索互联网世界中无限的可能性，尤其是AI技术的应用和落地🎉🎉',
