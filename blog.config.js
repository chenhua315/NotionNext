...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'fukasawa', // 当主题名称就前主题，在themes文件夹下可找到所有支持的主题；是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  GREETING_WORDS:
    ...
    'Hi，我是凯叔，一名全身心投入于AI技术、互联网营销和网络创业的数字游民。<br>我将带你探索互联网世界中无限的可能性，尤其是AI技术的应用和落地🎉🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '凯叔高效研究院', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '探索AI的数字游民，凯叔陪您高效开心工作💼', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kaishu.i9x.cn/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '凯叔,AI,高效工作,ChatGPT,人工智能', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'h.chen@i9x.cn', // 邮箱地址 例如mail@tangly1024.com
