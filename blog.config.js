...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'heo', // 当主题名称就前主题，在themes文件夹下可找到所有支持的主题；是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  GREETING_WORDS:
    ...
    '一名全身心投入于AI技术、互联网营销和网络创业的数字游民🎉🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '凯叔-高效工作', // 您的昵称 例如 tangly1024
